...
const EMPTY = { nama: "", kategori: "", jumlah_default: "", satuan: "", lokasi: "" };

export default function CatalogItemModal({ isOpen, onClose, onSubmit, item }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <form onSubmit={handleSubmit}>
        <ModalHeader>{isEdit ? "Edit Item Katalog" : "Tambah ke Katalog"}</ModalHeader>
        <ModalBody>
          <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className={LABEL}>Jumlah Biasa</label>
              <input
                type="number"
                placeholder="0"
                min="0"
        ...
        <ModalFooter>
          ...
          <button
            type="submit"
            disabled={!formData.nama || !formData.kategori || !formData.jumlah_default || !formData.satuan}
